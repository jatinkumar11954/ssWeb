...
NEWSCHEMA('User').make(function(schema) {
	...
	schema.define('street', String);
	schema.define('city', String);
	schema.define('zip', String);
	schema.define('state', String);
...
NEWSCHEMA('UserOrder').make(function(schema) {
	...
	schema.setGet(function($) {
		...
		NOSQL('orders').one().where('iduser', $.user.id).sort('datecreated', true)
		.fields('iduser', 'firstname', 'lastname', 'billingstreet', 'billingcity', 'billingzip', 'billingcountry', 'email', 'phone', 'iscompany', 'company', 'companyvat', 'companyid')
