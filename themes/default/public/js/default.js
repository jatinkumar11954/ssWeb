...
// $(document).ready(function($) {
	...
	// 	SETTER('shoppingcart', 'add', btn.attr('id'), +btn.attr('price'), 1, btn.attr('name'), btn.attr('idvariant'), btn.attr('variant'));
...
function refresh_prices() {
	...
	FIND('shoppingcart', function(com) {
		...
		items.each(function() {
			...
			var el = $(t);
			var price = +el.attr('new');
			var priceold = +el.attr('old');
			var currency = el.attr('currency');
			var p;
